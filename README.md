# HFK 일본 와이너리 투어 시음 기록

일본 와이너리를 방문하며 시음한 와인을 기록하고, 멤버 각자가 시음 노트를 남길 수 있는 웹 페이지입니다.
...
- `japan-tour.gs` — Google Apps Script 백엔드 (Sheets 읽기/쓰기)
...
1. [script.google.com](https://script.google.com) 접속 → 새 프로젝트 → 이름 "HFK Japan Winery Tour"
2. 기본 `Code.gs` 전부 지우고 `japan-tour.gs` 내용 붙여넣기
...
1. 새 GitHub 저장소 생성 (예: `hfk-japan-winery-tour`)
2. `index.html` 을 저장소 루트에 푸시
3. 저장소 **Settings → Pages**:
   - Source: `Deploy from a branch`
   - Branch: `main` / `(root)`
4. 1–2분 뒤 `https://{사용자명}.github.io/hfk-japan-winery-tour/` 에서 접속
